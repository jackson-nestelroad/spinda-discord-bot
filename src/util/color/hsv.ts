...
export class HSVAColor implements HSVAInterface {
    ...
    private constructor(hue: number, saturation: number, value: number, alpha: number = 1) {
        this.hue = hue;
    ...
    public toRGB(): RGBAColor {
        ...
        switch (i % 6) {
            case 0:
                (r = this.value), (g = t), (b = p);
                break;
            case 1:
                (r = q), (g = this.value), (b = p);
                break;
            case 2:
                (r = p), (g = this.value), (b = t);
                break;
            case 3:
                (r = p), (g = q), (b = this.value);
                break;
            case 4:
                (r = t), (g = p), (b = this.value);
                break;
            case 5:
                (r = this.value), (g = p), (b = q);
                break;
        }
